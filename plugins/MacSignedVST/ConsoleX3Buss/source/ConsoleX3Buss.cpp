/* ========================================
 *  ConsoleX3Buss - ConsoleX3Buss.h
 *  Copyright (c) airwindows, Airwindows uses the MIT license
 * ======================================== */

#ifndef __ConsoleX3Buss_H
#include "ConsoleX3Buss.h"
#endif

AudioEffect* createEffectInstance(audioMasterCallback audioMaster) {return new ConsoleX3Buss(audioMaster);}

ConsoleX3Buss::ConsoleX3Buss(audioMasterCallback audioMaster) :
...
ConsoleX3Buss::~ConsoleX3Buss() {}
VstInt32 ConsoleX3Buss::getVendorVersion () {return 1000;}
void ConsoleX3Buss::setProgramName(char *name) {vst_strncpy (_programName, name, kVstMaxProgNameLen);}
void ConsoleX3Buss::getProgramName(char *name) {vst_strncpy (name, _programName, kVstMaxProgNameLen);}
...
VstInt32 ConsoleX3Buss::getChunk (void** data, bool isPreset)
{
...
VstInt32 ConsoleX3Buss::setChunk (void* data, VstInt32 byteSize, bool isPreset)
{	
...
void ConsoleX3Buss::setParameter(VstInt32 index, float value) {
    switch (index) {
...
float ConsoleX3Buss::getParameter(VstInt32 index) {
    switch (index) {
...
void ConsoleX3Buss::getParameterName(VstInt32 index, char *text) {
    switch (index) {
...
void ConsoleX3Buss::getParameterDisplay(VstInt32 index, char *text) {
    switch (index) {
...
void ConsoleX3Buss::getParameterLabel(VstInt32 index, char *text) {
    switch (index) {
...
VstInt32 ConsoleX3Buss::canDo(char *text) 
{ return (_canDo.find(text) == _canDo.end()) ? -1: 1; } // 1 = yes, -1 = no, 0 = don't know

bool ConsoleX3Buss::getEffectName(char* name) {
    vst_strncpy(name, "ConsoleX3Buss", kVstMaxProductStrLen); return true;
}

VstPlugCategory ConsoleX3Buss::getPlugCategory() {return kPlugCategEffect;}

bool ConsoleX3Buss::getProductString(char* text) {
  	vst_strncpy (text, "airwindows ConsoleX3Buss", kVstMaxProductStrLen); return true;
}

bool ConsoleX3Buss::getVendorString(char* text) {
