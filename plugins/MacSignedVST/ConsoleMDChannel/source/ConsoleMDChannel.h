...
const unsigned long kUniqueId = 'cmce';    //Change this to what the AU identity is!

class ConsoleMDChannel : 
    public AudioEffectX 
{
public:
    ConsoleMDChannel(audioMasterCallback audioMaster);
    ~ConsoleMDChannel();
