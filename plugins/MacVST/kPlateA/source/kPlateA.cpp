...
kPlateA::~kPlateA() {}
VstInt32 kPlateA::getVendorVersion () {return 1000;}
void kPlateA::setProgramName(char *name) {vst_strncpy (_programName, name, kVstMaxProgNameLen);}
void kPlateA::getProgramName(char *name) {vst_strncpy (name, _programName, kVstMaxProgNameLen);}
...
VstInt32 kPlateA::getChunk (void** data, bool isPreset)
{
...
VstInt32 kPlateA::setChunk (void* data, VstInt32 byteSize, bool isPreset)
{	
...
void kPlateA::setParameter(VstInt32 index, float value) {
    switch (index) {
...
float kPlateA::getParameter(VstInt32 index) {
    switch (index) {
...
void kPlateA::getParameterName(VstInt32 index, char *text) {
    switch (index) {
...
void kPlateA::getParameterDisplay(VstInt32 index, char *text) {
    switch (index) {
...
void kPlateA::getParameterLabel(VstInt32 index, char *text) {
    switch (index) {
...
VstInt32 kPlateA::canDo(char *text) 
{ return (_canDo.find(text) == _canDo.end()) ? -1: 1; } // 1 = yes, -1 = no, 0 = don't know

bool kPlateA::getEffectName(char* name) {
    vst_strncpy(name, "kPlateA", kVstMaxProductStrLen); return true;
}

VstPlugCategory kPlateA::getPlugCategory() {return kPlugCategEffect;}

bool kPlateA::getProductString(char* text) {
  	vst_strncpy (text, "airwindows kPlateA", kVstMaxProductStrLen); return true;
}

bool kPlateA::getVendorString(char* text) {
