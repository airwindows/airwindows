...
const unsigned long kUniqueId = 'pc4b';    //Change this to what the AU identity is!

class PurestConsole4Buss : 
    public AudioEffectX 
{
public:
    PurestConsole4Buss(audioMasterCallback audioMaster);
    ~PurestConsole4Buss();
