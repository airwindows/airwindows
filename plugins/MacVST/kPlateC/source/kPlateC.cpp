...
kPlateC::kPlateC(audioMasterCallback audioMaster) :
...
kPlateC::~kPlateC() {}
VstInt32 kPlateC::getVendorVersion () {return 1000;}
void kPlateC::setProgramName(char *name) {vst_strncpy (_programName, name, kVstMaxProgNameLen);}
void kPlateC::getProgramName(char *name) {vst_strncpy (name, _programName, kVstMaxProgNameLen);}
...
VstInt32 kPlateC::getChunk (void** data, bool isPreset)
{
...
VstInt32 kPlateC::setChunk (void* data, VstInt32 byteSize, bool isPreset)
{	
...
void kPlateC::setParameter(VstInt32 index, float value) {
    switch (index) {
...
float kPlateC::getParameter(VstInt32 index) {
    switch (index) {
...
void kPlateC::getParameterName(VstInt32 index, char *text) {
    switch (index) {
...
void kPlateC::getParameterDisplay(VstInt32 index, char *text) {
    switch (index) {
...
void kPlateC::getParameterLabel(VstInt32 index, char *text) {
    switch (index) {
...
VstInt32 kPlateC::canDo(char *text) 
{ return (_canDo.find(text) == _canDo.end()) ? -1: 1; } // 1 = yes, -1 = no, 0 = don't know

bool kPlateC::getEffectName(char* name) {
    vst_strncpy(name, "kPlateC", kVstMaxProductStrLen); return true;
}

VstPlugCategory kPlateC::getPlugCategory() {return kPlugCategEffect;}

bool kPlateC::getProductString(char* text) {
  	vst_strncpy (text, "airwindows kPlateC", kVstMaxProductStrLen); return true;
}

bool kPlateC::getVendorString(char* text) {
