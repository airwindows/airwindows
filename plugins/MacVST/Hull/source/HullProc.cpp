...
void Hull::processReplacing(float **inputs, float **outputs, VstInt32 sampleFrames) 
{
    ...
    while (--sampleFrames >= 0)
    {
		...
		int x = bPointer;
		long double longAverageL = 0.0;
		long double longAverageR = 0.0;
		long double shortAverageL = 0.0;
		long double shortAverageR = 0.0;
		...
		x = cPointer;
		long double shortestAverageL = 0.0;
		long double shortestAverageR = 0.0;
