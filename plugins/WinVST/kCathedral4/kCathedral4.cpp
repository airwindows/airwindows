...
AudioEffect* createEffectInstance(audioMasterCallback audioMaster) {return new kCathedral4(audioMaster);}

kCathedral4::kCathedral4(audioMasterCallback audioMaster) :
...
kCathedral4::~kCathedral4() {}
VstInt32 kCathedral4::getVendorVersion () {return 1000;}
void kCathedral4::setProgramName(char *name) {vst_strncpy (_programName, name, kVstMaxProgNameLen);}
void kCathedral4::getProgramName(char *name) {vst_strncpy (name, _programName, kVstMaxProgNameLen);}
...
VstInt32 kCathedral4::getChunk (void** data, bool isPreset)
{
...
VstInt32 kCathedral4::setChunk (void* data, VstInt32 byteSize, bool isPreset)
{	
...
void kCathedral4::setParameter(VstInt32 index, float value) {
    switch (index) {
...
float kCathedral4::getParameter(VstInt32 index) {
    switch (index) {
...
void kCathedral4::getParameterName(VstInt32 index, char *text) {
    switch (index) {
...
void kCathedral4::getParameterDisplay(VstInt32 index, char *text) {
    switch (index) {
...
void kCathedral4::getParameterLabel(VstInt32 index, char *text) {
    switch (index) {
...
VstInt32 kCathedral4::canDo(char *text) 
{ return (_canDo.find(text) == _canDo.end()) ? -1: 1; } // 1 = yes, -1 = no, 0 = don't know

bool kCathedral4::getEffectName(char* name) {
    vst_strncpy(name, "kCathedral4", kVstMaxProductStrLen); return true;
}

VstPlugCategory kCathedral4::getPlugCategory() {return kPlugCategEffect;}

bool kCathedral4::getProductString(char* text) {
  	vst_strncpy (text, "airwindows kCathedral4", kVstMaxProductStrLen); return true;
}

bool kCathedral4::getVendorString(char* text) {
