...
Energy2::~Energy2() {}
VstInt32 Energy2::getVendorVersion () {return 1000;}
void Energy2::setProgramName(char *name) {vst_strncpy (_programName, name, kVstMaxProgNameLen);}
void Energy2::getProgramName(char *name) {vst_strncpy (name, _programName, kVstMaxProgNameLen);}
...
VstInt32 Energy2::getChunk (void** data, bool isPreset)
{
...
VstInt32 Energy2::setChunk (void* data, VstInt32 byteSize, bool isPreset)
{	
...
void Energy2::setParameter(VstInt32 index, float value) {
    switch (index) {
...
float Energy2::getParameter(VstInt32 index) {
    switch (index) {
...
void Energy2::getParameterName(VstInt32 index, char *text) {
    switch (index) {
...
void Energy2::getParameterDisplay(VstInt32 index, char *text) {
    switch (index) {
...
void Energy2::getParameterLabel(VstInt32 index, char *text) {
    switch (index) {
...
VstInt32 Energy2::canDo(char *text) 
{ return (_canDo.find(text) == _canDo.end()) ? -1: 1; } // 1 = yes, -1 = no, 0 = don't know

bool Energy2::getEffectName(char* name) {
    vst_strncpy(name, "Energy2", kVstMaxProductStrLen); return true;
}

VstPlugCategory Energy2::getPlugCategory() {return kPlugCategEffect;}

bool Energy2::getProductString(char* text) {
  	vst_strncpy (text, "airwindows Energy2", kVstMaxProductStrLen); return true;
}

bool Energy2::getVendorString(char* text) {
